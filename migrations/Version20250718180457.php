 ...
 */
final class Version20250718180457 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE asset (id SERIAL NOT NULL, company_id INT NOT NULL, ticker VARCHAR(6) NOT NULL, type VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_2AF5A5C979B1AD6 ON asset (company_id)');
        $this->addSql('CREATE TABLE bill (id SERIAL NOT NULL, bill_id INT NOT NULL, company_id INT DEFAULT NULL, date_reference DATE NOT NULL, value DOUBLE PRECISION NOT NULL, comment VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE company (id SERIAL NOT NULL, sector_id INT NOT NULL, name VARCHAR(128) NOT NULL, cnpj VARCHAR(32) NOT NULL, isin VARCHAR(16) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_4FBF094FDE95C867 ON company (sector_id)');
        $this->addSql('CREATE TABLE credit_card (id SERIAL NOT NULL, card VARCHAR(64) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE users (id SERIAL NOT NULL, username VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, last_login TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
